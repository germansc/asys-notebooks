...
| `TP7/TP7E2.py` | TP7 — Ejercicio 2: TDF de un coseno | [![Open in molab](https://marimo.io/molab-shield.svg)](https://molab.marimo.io/github/germansc/asys-notebooks/blob/master/TP7/TP7E2.py/wasm?show-code=false) |
